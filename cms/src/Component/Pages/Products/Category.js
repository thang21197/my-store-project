          ...
          <div className="row">
            <div className="col-md-5">
              <div className="form-group">
                <label htmlFor="true">Danh mục cha:</label>
              ...
              <div className="form-group">
                <label htmlFor="true">Tên Danh mục</label>
                <input type="text" className="form-control" name="name"  placeholder="Tên danh mục mới" />
            ...
            <div className="col-md-7">
              <div className="alert bg-success" role="alert">
                ...
                </svg> Đã thêm danh mục thành công! <a href="/" className="pull-right"><span className="glyphicon glyphicon-remove" /></a>
              </div>
              ...
              <div className="vertical-menu">
                ...
                <div className="item-menu"><span>Nam</span>
                  <div className="category-fix">
                    <a className="btn-category btn-primary" href="editcategory.html"><i className="fa fa-edit" /></a>
                    <a className="btn-category btn-danger" href="/"><i className="fas fa-times" /></a>
                  </div>
                </div>
